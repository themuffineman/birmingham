...
export async function POST(req){
    ...
    try{
        ...
        const mailOptions = {
            ...
            text: `Hello ${name}! I hope all is well over there. I recently had the chance to look at your website and I believe it can be massively improved. That's why I'd like to offer you a full free website audit. There's no catch, I just want to show you where your website could be improved and how it can drive real results for your business. Your website has the potential to be a powerful asset for your business, and I'd hate to see it go underutilized. Just give me the green light and I'll start with the audit report. My name is Petrus by the way I help businesses turn their websites into money making assets.`,
