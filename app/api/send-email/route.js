...
export async function POST(req){
    ...
    try{
        ...
        const mailOptions = {
            ...
            html: `<main style='display: flex; padding: 2rem; flex-direction: column; gap: 1rem; font-family: Arial, Helvetica, sans-serif;'><header><h1 style='font-size: 1rem; color: black; font-weight: bold; margin: .5rem;'>Hello ${name}!</h1><p style='font-size: 1rem; color: black; font-weight: light; margin: .5rem;'>I hope all is well over there.</p><p style='font-size: 1rem; color: black; font-weight: light; margin: .5rem;'>I recently had the chance to look at your website and I believe it can be massively improved. That's why I'd like to offer you a <span style='font-weight: bold;'>free</span> website redesign. This way, I can demonstrate its capability to convert leads and drive tangible results for your business. If you like it, we can proceed with further collaboration. If not, there's no obligation, and you won't pay a dime.</p><p style='font-size: 1rem; color: black; font-weight: light; margin: .5rem;'>Your website has the potential to be a powerful asset for your business, and I'd hate to see it go underutilized.</p><p style='font-size: 1rem; color: black; font-weight: normal; margin: .5rem;'> I'm available to schedule a call to talk about your goals and how we can help you achieve them through your website. My name is Petrus by the way I help businesses turn their websites into money making assets.</p></header><section><p>From your friendly neighbourhood web developer</p><p style='font-weight: bold;'>Petrus</p></section></main>`
        }
