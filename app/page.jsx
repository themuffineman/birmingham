...
export default function Home() {
  ...
  const [leadsData, setLeadsData] = useState([{name: 'Petrus Inc', emails: ['petrusheya@gmail.com', 'petrusheya+2@gmail.com']}, {name: 'Petrus Inc', emails: ['petrusheya@gmail.com', 'petrusheya+2@gmail.com']}])
